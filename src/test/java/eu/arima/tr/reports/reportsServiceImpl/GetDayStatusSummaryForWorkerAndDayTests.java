...
class GetDayStatusSummaryForWorkerAndDayTests {
	...
	@Test
	void when_the_worklogs_for_the_resquested_day_are_1_5_1_hours_the_status_is_MISSING_HOURS() {
		...
		when(worklogRepository.findByUsernameAndDate(ArgumentMatchers.anyString(),
				ArgumentMatchers.any(LocalDate.class))).thenReturn(Arrays.asList(oneHourWL, fiveHoursWL, oneHourWL));
	...
	@Test
	void when_the_worklogs_for_the_resquested_day_are_1_6_1_hours_the_status_is_RIGHT_HOURS() {
		Worklog oneHourWL = mock(Worklog.class);
	...
	@Test
	void when_the_worklogs_for_the_resquested_day_are_1_6_2_hoursthe_status_is_EXTRA_HOURS() {
		Worklog oneHourWL = mock(Worklog.class);
		Worklog sixHoursWL = mock(Worklog.class);
		...
		when(worklogRepository.findByUsernameAndDate(ArgumentMatchers.anyString(),
				ArgumentMatchers.any(LocalDate.class))).thenReturn(Arrays.asList(oneHourWL, sixHoursWL, twoHoursWL));
